...
// autocompletion. Subcommand autocompletion will work even if tis interface
...
// this scenario, both help ahdn HelpTemplate should be implemented. 
// 
...
// We need a factory because we way need to setup some state on the 

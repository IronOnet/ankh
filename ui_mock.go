...
// which is safer for concurrent use.
...
// MockUi is a mock UI taht is used for tests and is exported publicly 
// for use in external tests if needed as well. Do not instantiate this 
